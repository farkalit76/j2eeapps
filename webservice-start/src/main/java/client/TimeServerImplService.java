 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://ts.chapter1.webreading.farkalit.com/", wsdlLocation = "http://localhost:8030/ts?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIMESERVERIMPLSERVICE_QNAME = new QName("http://ts.chapter1.webreading.farkalit.com/", "TimeServerImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8030/ts?wsdl");
    ...
    public TimeServer getTimeServerImplPort() {
        return super.getPort(new QName("http://ts.chapter1.webreading.farkalit.com/", "TimeServerImplPort"), TimeServer.class);
    }
    ...
    public TimeServer getTimeServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ts.chapter1.webreading.farkalit.com/", "TimeServerImplPort"), TimeServer.class, features);
    }
