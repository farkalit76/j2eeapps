 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://team.chapter1.webreading.farkalit.com/", wsdlLocation = "http://localhost:8030/teams?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEAMSSERVICE_QNAME = new QName("http://team.chapter1.webreading.farkalit.com/", "TeamsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8030/teams?wsdl");
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://team.chapter1.webreading.farkalit.com/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://team.chapter1.webreading.farkalit.com/", "TeamsPort"), Teams.class, features);
    }
