 ...
 */
package com.farkalit.webreading.chapter1.soap;
...
public class DemoSoap {
    ...
    private void request()
    {
        try
        {
            ...
            // Simulate sending the SOAP message toemote system by 
    ...
    private SOAPMessage  create_soap_message(InputStream in)
    {
        ...
        {
            MessageFactory mf = MessageFactory.newInstance();
            msg = mf.createMessage(null, /* ignore MIME headers */  in); // stream source
        } catch (SOAPException e)
        {
            System.err.println(e);
        } catch (IOException e)
