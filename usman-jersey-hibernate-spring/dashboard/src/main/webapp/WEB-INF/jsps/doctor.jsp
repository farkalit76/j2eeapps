...
<html>
    ...
    <body>
        ...
        <form:form action="create" method="post"  modelAttribute="doctor" >
            ...
            <table width="60%" >
                <tr >
                    <td width="20%">Name:</td><td width="80%"><form:input path="name"  size="20" maxlength="50"/></td>
                </tr>
                <tr>
                    <td>Degree</td><td><form:input path="degree"  size="20" maxlength="50"/></td>
                </tr>
                <tr>
                    <td>Profession:</td><td>
    ...
    <tr>
        <td>
            <c:choose>
                ...
                <c:otherwise>
                    <input type="submit"  value="Submit" onclick="return validateDoctor();" />&nbsp;
                </c:otherwise>
            </c:choose>
