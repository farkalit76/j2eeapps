<%-- 
    Document   : metadata
    Created on : 28 Aug, 2015, 10:47:59 AM
    Author     : 72010995
--%>
<%@page import="com.usman.study.controller.vo.Contact"%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="app/css/displaytag.css" type="text/css">
        <link rel="stylesheet" href="app/css/screen.css" type="text/css">
        <link rel="stylesheet" href="app/css/site.css" type="text/css">
    ...
    <body>
        ...
        <div id='tab1' class="tab_content" style="display: block; width: 100%">
            ...
            <display:table name="sessionScope.players" pagesize="5"
                ...
                <display:column property="moblie" title="Mobile"
                                sortable="true" headerClass="sortable" />
                <display:column property="resident" title="Resident"
                                sortable="true" headerClass="sortable" />
            </display:table>
        </div>
