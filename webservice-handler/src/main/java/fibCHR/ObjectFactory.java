 ...
 * generated in the fibCHR package. 
...
public class ObjectFactory {
    ...
    private final static QName _CountRabbitsResponse_QNAME = new QName("http://chapter3.webreading.farkalit.com/fibc", "countRabbitsResponse");
    private final static QName _FibException_QNAME = new QName("http://chapter3.webreading.farkalit.com/fibc", "FibException");
    private final static QName _CountRabbits_QNAME = new QName("http://chapter3.webreading.farkalit.com/fibc", "countRabbits");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fibCHR
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://chapter3.webreading.farkalit.com/fibc", name = "countRabbitsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://chapter3.webreading.farkalit.com/fibc", name = "FibException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://chapter3.webreading.farkalit.com/fibc", name = "countRabbits")
